...
{
    public interface ITransAuditStokOpnameService
    {
        Task<tr_audit_stok_opname_header_recursive> GetTrAuditStokOpnameHeaderById(long audit_stok_opname_id);
        Task<List<tr_audit_stok_opname_header>> GetAllTrAuditStokOpnameHeaderByParams(List<ParameterSearchModel> param);
        Task<List<tr_audit_stok_opname_header>> GetAllTrAuditStokOpnameHeaderOpenByParams(List<ParameterSearchModel> param);

        Task<List<tr_audit_stok_opname_lookup_barang_header>> GetLookupBarangStokCapture(
            tr_audit_stok_opname_lookup_barang_param param
            );

        Task<List<tr_audit_stok_opname_lookup_barang_batch>> GetLookupBatchByIdItemAndIdStockroomAndWaktuCapture(
            tr_audit_stok_opname_lookup_barang_batch_param param
            );

        Task<(bool, long, string)> AddTrAuditStokOpnameHeader(tr_audit_stok_opname_header_insert data);
        Task<(bool, long, string)> Adjustment(tr_audit_stok_opname_header_update_after_adjust data);
        Task<(bool, long, string)> Finalisasi(tr_audit_stok_opname_header_update_after_proses data);


        #region Detail

        Task<List<tr_audit_stok_opname_detail_for_adjustment_finalisasi>> GetTrAuditStokOpnameDetailByHeaderIdAndWaktuCapture(
        ...
        Task<List<tr_audit_stok_opname_detail_batch_for_adjustment_finalisasi>> GetTrAuditStokOpnameDetailBatchByDetailIdAndWaktuCapture(
    ...
    public class TransAuditStokOpnameService : ITransAuditStokOpnameService
    {
        private readonly SQLConn _db;
        private readonly TransAuditStokOpnameDao _dao;
        private readonly TransSettingAuditStokOpnameDao _settingDao;
        ...
        public TransAuditStokOpnameService(
            SetupStokItemDao stokItemDao,
            KartuStokItemDao kartuStokDao,
            MasterCounterDao kodeDao,
            SQLConn db, TransAuditStokOpnameDao dao,
            TransSettingAuditStokOpnameDao settingDao)
        {
            this._db = db;
            this._dao = dao;
            this._kodeDao = kodeDao;
            this._settingDao = settingDao;
        ...
        public async Task<List<tr_audit_stok_opname_lookup_barang_header>> GetLookupBarangStokCapture(
            tr_audit_stok_opname_lookup_barang_param param
            )
        {
            try
            {
                var result = new List<tr_audit_stok_opname_lookup_barang_header>();
                var setting = await this._settingDao.GetTrSettingAuditStokOpnameHeaderById(param.setting_stok_opname_id);

                switch (setting.id_jenis_setting_stok_opname)
                {
                    case 1: result = await this._dao.GetLookupBarangAllItemByIdStockroomAndWaktuCapture(param); break;
                    case 2: result = await this._dao.GetLookupBarangPerGrupByIdRakAndIdStockroomAndWaktuCapture(param); break;
                    case 3: result = await this._dao.GetLookupBarangPerRakByIdRakAndIdStockroomAndWaktuCapture(param); break;
                    case 4: result = await this._dao.GetLookupBarangPerItemByIdRakAndIdStockroomAndWaktuCapture(param); break;
                }
        ...
        public async Task<(bool, long, string)> AddTrAuditStokOpnameHeader(tr_audit_stok_opname_header_insert data)
        {
        ...
        public async Task<(bool, long, string)> Adjustment(tr_audit_stok_opname_header_update_after_adjust data)
        {
        ...
        public async Task<(bool, long, string)> Finalisasi(tr_audit_stok_opname_header_update_after_proses data)
        {
        ...
        public async Task<List<tr_audit_stok_opname_detail_for_adjustment_finalisasi>> GetTrAuditStokOpnameDetailByHeaderIdAndWaktuCapture(tr_audit_stok_opname_detail_getby_headerid_and_waktu param)
        {
            try
            {
        ...
        public async Task<List<tr_audit_stok_opname_detail_batch_for_adjustment_finalisasi>> GetTrAuditStokOpnameDetailBatchByDetailIdAndWaktuCapture(tr_audit_stok_opname_detail_batch_getby_detailid_and_waktu param)
        {
            try
            {
