...
{
    public interface ITransAuditStokOpnameNoEdService
    {
        Task<tr_audit_stok_opname_no_ed_header_recursive> GetTrAuditStokOpnameHeaderById(long audit_stok_opname_id);
        Task<List<tr_audit_stok_opname_no_ed_header>> GetAllTrAuditStokOpnameHeaderByParams(List<ParameterSearchModel> param);
        Task<List<tr_audit_stok_opname_no_ed_header>> GetAllTrAuditStokOpnameHeaderOpenByParams(List<ParameterSearchModel> param);

        Task<List<tr_audit_stok_opname_no_ed_lookup_barang_header>> GetLookupBarangStokCapture(
            tr_audit_stok_opname_no_ed_lookup_barang_param param
            );

        Task<(bool, long, string)> AddTrAuditStokOpnameHeader(tr_audit_stok_opname_no_ed_header_insert data);
        Task<(bool, long, string)> Adjustment(tr_audit_stok_opname_no_ed_header_update_after_adjust data);
        Task<(bool, long, string)> Finalisasi(tr_audit_stok_opname_no_ed_header_update_after_proses data);

        #region Detail

        Task<List<tr_audit_stok_opname_no_ed_detail_for_adjustment_finalisasi>> GetTrAuditStokOpnameDetailByHeaderIdAndWaktuCapture(
    ...
    public class TransAuditStokOpnameNoEdService : ITransAuditStokOpnameNoEdService
    {
        private readonly SQLConn _db;
        private readonly TransAuditStokOpnameNoEdDao _dao;
        ...
        public async Task<List<tr_audit_stok_opname_no_ed_lookup_barang_header>> GetLookupBarangStokCapture(
            tr_audit_stok_opname_no_ed_lookup_barang_param param
            )
        {
            try
            {
                var result = new List<tr_audit_stok_opname_no_ed_lookup_barang_header>();
        ...
        public async Task<(bool, long, string)> AddTrAuditStokOpnameHeader(tr_audit_stok_opname_no_ed_header_insert data)
        {
        ...
        public async Task<(bool, long, string)> Adjustment(tr_audit_stok_opname_no_ed_header_update_after_adjust data)
        {
        ...
        public async Task<(bool, long, string)> Finalisasi(tr_audit_stok_opname_no_ed_header_update_after_proses data)
        {
        ...
        public async Task<List<tr_audit_stok_opname_no_ed_detail_for_adjustment_finalisasi>> GetTrAuditStokOpnameDetailByHeaderIdAndWaktuCapture(tr_audit_stok_opname_no_ed_detail_getby_headerid_and_waktu param)
        {
            try
            {
