...
{
    public class TransReturPemakaianInternalDao
    {
        public SQLConn db;

        public TransReturPemakaianInternalDao(SQLConn db)
        {
            this.db = db;
        }
        ...
        public async Task<List<tr_retur_pemakaian_internal>> GetAllTrReturPemakaianInternalByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_retur_pemakaian_internal>("tr_retur_pemakaian_internal_GetByDynamicFilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<tr_retur_pemakaian_internal> GetTrReturPemakaianInternalById(long retur_pemakaian_internal_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_retur_pemakaian_internal>("tr_retur_pemakaian_internal_GetById", new
                {
        ...
        public async Task<tr_retur_pemakaian_internal> GetTrReturPemakaianInternalByIdWithLock(long retur_pemakaian_internal_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_retur_pemakaian_internal>("tr_retur_pemakaian_internal_GetById_lock", new
                {
                    _retur_pemakaian_internal_id = retur_pemakaian_internal_id
                });
            }
        ...
        public async Task<long> AddTrReturPemakaianInternal(tr_retur_pemakaian_internal_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_retur_pemakaian_internal_Insert",
                    new
                    {
        ...
        public async Task<short> UpdateTrReturPemakaianInternalValidated(tr_retur_pemakaian_internal_update_to_validated data)
        {
            try
            {
        ...
        public async Task<short> UpdateTrReturPemakaianInternalCanceled(tr_retur_pemakaian_internal_update_to_canceled data)
        {
            try
            {
        ...
        public async Task<List<tr_retur_pemakaian_internal_detail_item>> GetAllTrReturPemakaianInternalDetailItemByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_retur_pemakaian_internal_detail_item>("tr_retur_pemakaian_internal_detail_item_GetByDynamicFilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<List<tr_retur_pemakaian_internal_detail_item>> GetTrReturPemakaianInternalDetailItemByHeaderId(long retur_pemakaian_internal_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_retur_pemakaian_internal_detail_item>("tr_retur_pemakaian_internal_detail_item_get_by_headerid", new
                {
                    _retur_pemakaian_internal_id = retur_pemakaian_internal_id
                });
            }
        ...
        public async Task<List<tr_retur_pemakaian_internal_detail_item>> GetTrReturPemakaianInternalDetailItemByHeaderIdWithLock(long retur_pemakaian_internal_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_retur_pemakaian_internal_detail_item>("tr_retur_pemakaian_internal_detail_item_Getby_headerid_lock", new
                {
                    _retur_pemakaian_internal_id = retur_pemakaian_internal_id
                });
            }
        ...
        public async Task<long> AddTrReturPemakaianInternalDetailItem(tr_retur_pemakaian_internal_detail_item_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_retur_pemakaian_internal_detail_item_Insert",
                    new
                    {
                        _retur_pemakaian_internal_id = data.retur_pemakaian_internal_id,
        ...
        public async Task<tr_retur_pemakaian_internal_detail_upload> GetTrReturPemakaianInternalDetailUploadById(long retur_pemakaian_internal_detail_upload_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_retur_pemakaian_internal_detail_upload>("tr_retur_pemakaian_internal_detail_upload_getbyid", new
                {
        ...
        public async Task<List<tr_retur_pemakaian_internal_detail_upload>> GetTrReturPemakaianInternalDetailUploadHeaderId(long retur_pemakaian_internal_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_retur_pemakaian_internal_detail_upload>("tr_retur_pemakaian_internal_detail_upload_get_by_headerid",
                    new
                    {
                        _retur_pemakaian_internal_id = retur_pemakaian_internal_id
                    });
