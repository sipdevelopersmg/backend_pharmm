...
{
    public class TransAuditStokOpnameTanpaSettingNoEdDao
    {
        public SQLConn db;

        public TransAuditStokOpnameTanpaSettingNoEdDao(SQLConn db)
        {
            this.db = db;
        }
            ...
            )
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_audit_stok_opname_no_ed_setting_lookup_barang_header>(
                    "tr_audit_stok_opname_get_item_by_idgudang_waktu_no_ed_params", new
                    {
        ...
        public async Task<List<tr_audit_stok_opname_no_ed_setting_header>> GetAllTrAuditStokOpnameHeaderByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_audit_stok_opname_no_ed_setting_header>("tr_audit_stok_opname_no_ed_setting_header_getbydynamicfilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<List<tr_audit_stok_opname_no_ed_setting_header>> GetAllTrAuditStokOpnameHeaderOpenByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_audit_stok_opname_no_ed_setting_header>("tr_audit_stok_opname_no_ed_setting_header_open_getbydynamicfilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<tr_audit_stok_opname_no_ed_setting_header_recursive> GetTrAuditStokOpnameHeaderByIdWithLock(long audit_stok_opname_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_audit_stok_opname_no_ed_setting_header_recursive>("tr_audit_stok_opname_no_setting_header_getbyid_lock", new
                {
                    _audit_stok_opname_id = audit_stok_opname_id
                });
            }
        ...
        public async Task<long> AddTrAuditStokOpnameHeader(tr_audit_stok_opname_no_ed_setting_header_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_audit_stok_opname_no_ed_setting_header_insert",
                    new
                    {
        ...
        public async Task<long> AddTrAuditStokOpnameDetail(tr_audit_stok_opname_no_ed_setting_detail_insert data)
        {
            try
            {
        ...
        public async Task<long> UpdateFinalisasi(tr_audit_stok_opname_no_ed_setting_header_update_after_proses data)
        {
            try
            {
        ...
        public async Task<long> UpdateAdjustment(tr_audit_stok_opname_no_ed_setting_header_update_after_adjust data)
        {
            try
            {
        ...
        public async Task<List<tr_audit_stok_opname_no_ed_setting_detail_for_adjustment_finalisasi>> GetTrAuditStokOpnameDetailByHeaderIdAndWaktuCapture(
            tr_audit_stok_opname_no_ed_setting_detail_getby_headerid_and_waktu param)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_audit_stok_opname_no_ed_setting_detail_for_adjustment_finalisasi>("tr_audit_stok_opname_detail_getby_headerid_and_waktu", new
                {
        ...
        public async Task<long> UpdateDetailAdjustment(tr_audit_stok_opname_no_ed_setting_detail_update_after_adjust data)
        {
            try
            {
