...
namespace Pharmm.API.Controllers.Transaksi
{
    ...
    [ApiController]
    public class TransAuditStokOpnameTanpaSettingNoEdController : ControllerBase
    {
        private readonly ITransAuditStokOpnameTanpaSettingNoEdService _service;
        private readonly ILogger<TransAuditStokOpnameTanpaSettingNoEdController> _logger;

        public TransAuditStokOpnameTanpaSettingNoEdController(
            ITransAuditStokOpnameTanpaSettingNoEdService service,
        ILogger<TransAuditStokOpnameTanpaSettingNoEdController> logger
        )
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_audit_stok_opname_no_ed_setting_lookup_barang_header>>))]
            ...
            )
        {
            ...
            try
            {
                var data = new tr_audit_stok_opname_no_ed_setting_lookup_barang_param();
                ...
                return Ok(ResponseHelper.GetResponse(
                    _data: new List<tr_audit_stok_opname_no_ed_setting_lookup_barang_header>(),
                    _message: "data tidak ditemukan",
                    _responseResult: true
                ));
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_audit_stok_opname_no_ed_setting_header>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_audit_stok_opname_no_ed_setting_header by dynamic filter (gunakan array kosong [] untuk get all data)",
       description: "prefix tr_audit_stok_opname_no_ed_setting_header tasoh (), <br>" +
        ...
        public async Task<IActionResult> GetAllStokOpnameByParams([FromBody] List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return Ok(ResponseHelper.GetResponse(
                    _data: new List<tr_audit_stok_opname_no_ed_setting_header>(),
                    _message: "data tidak ditemukan",
                    _responseResult: true
                ));
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_audit_stok_opname_no_ed_setting_header>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_audit_stok_opname_no_ed_setting_header yang masih open by dynamic filter (gunakan array kosong [] untuk get all data)",
       description: "prefix tr_audit_stok_opname_no_ed_setting_header tasoh (), <br>" +
            "mm_setup_stockroom mss (kode_stockroom,nama_stockroom), <br>" +
            "mm_setup_grup_item msgi (kode_grup_item,grup_item), <br>" +
            "mm_setup_audit_rak_storage msars (kode_rak_storage,nama_rak_storage)")]
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<tr_audit_stok_opname_no_ed_setting_detail_for_adjustment_finalisasi>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_audit_stok_opname_no_ed_setting_detail by id header dan waktu capture")]
        public async Task<IActionResult> GetDetailByHeaderIdAndWaktuCapture([FromBody] tr_audit_stok_opname_no_ed_setting_detail_getby_headerid_and_waktu param)
        {
            ...
            try
            {
                ...
                return Ok(ResponseHelper.GetResponse(
                    _data: new List<tr_audit_stok_opname_no_ed_setting_detail_for_adjustment_finalisasi>(),
                    _message: "data tidak ditemukan",
                    _responseResult: true
                ));
        ...
        public async Task<IActionResult> Insert([FromBody] tr_audit_stok_opname_no_ed_setting_header_insert param)
        {
            try
            {
        ...
        public async Task<IActionResult> Adjustment([FromBody] tr_audit_stok_opname_no_ed_setting_header_update_after_adjust param)
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<Int16?>))]
        [SwaggerOperation(summary: "untuk adjustment data audit stok opname")]
        public async Task<IActionResult> Finalisasi([FromBody] tr_audit_stok_opname_no_ed_setting_header_update_after_proses param)
        {
            try
            {
