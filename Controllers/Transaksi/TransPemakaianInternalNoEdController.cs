...
namespace Pharmm.API.Controllers.Transaksi
{
    ...
    [ApiController]
    public class TransPemakaianInternalNoEdController : ControllerBase
    {

        private ITransPemakaianInternalNoEdService _service;
        private ISetupUkuranDokumenService _dokumenService;
        private readonly ILogger<TransPemakaianInternalNoEdController> _logger;
        private readonly ISetupStokItemService _stokItemService;

        public TransPemakaianInternalNoEdController(ITransPemakaianInternalNoEdService service,
            ISetupUkuranDokumenService dokumenService,
        ILogger<TransPemakaianInternalNoEdController> logger,
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_pemakaian_internal_no_ed>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_pemakaian_internal_no_ed yang open " +
            "by dynamic filter (gunakan array kosong [] untuk get all data)",
            description: "prefix tr_pemakaian_internal_no_ed = tpi, <br>" +
        ...
        public async Task<IActionResult> GetAllOpenByParams([FromBody] List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return Ok(ResponseHelper.GetResponse(
                    _data: new List<tr_pemakaian_internal_no_ed>(),
                    _message: "data tidak ditemukan",
                    _responseResult: true
                ));
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_pemakaian_internal_no_ed>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_pemakaian_internal_no_ed by dynamic filter (gunakan array kosong [] untuk get all data)",
            description: "prefix tr_pemakaian_internal_no_ed = tpi, <br>" +
            "mm_setup_stockroom mss (kode_stockroom,nama_stockroom)")]
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<tr_pemakaian_internal_no_ed>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_pemakaian_internal_no_ed by id")]
        ...
        [SwaggerOperation(summary: "untuk input data tr_pemakaian_internal_no_ed")]
        public async Task<IActionResult> Insert([FromBody] tr_pemakaian_internal_no_ed_insert param)
        {
            try
            {
        ...
        public async Task<IActionResult> Validasi([FromBody] tr_pemakaian_internal_no_ed_update_to_validated param)
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<string>))]
        [SwaggerOperation(summary: "untuk update data tr_pemakaian_internal_no_ed")]
        public async Task<IActionResult> Batal([FromBody] tr_pemakaian_internal_no_ed_update_to_canceled param)
        {
            try
            {
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_pemakaian_internal_no_ed_detail_item>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_pemakaian_internal_no_ed_detail_item by dynamic filter (gunakan array kosong [] untuk get all data)",
            description: "prefix tr_pemakaian_internal_no_ed_detail_item = tpidi, <br>" +
        ...
        public async Task<IActionResult> GetAllDetailByParams([FromBody] List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return Ok(ResponseHelper.GetResponse(
                    _data: new List<tr_pemakaian_internal_no_ed_detail_item>(),
                    _message: "data tidak ditemukan",
                    _responseResult: true
                ));
        ...
        [HttpGet("{pemakaian_internal_id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_pemakaian_internal_no_ed_detail_item>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_pemakaian_internal_no_ed_detail_item by id")]
        ...
        [HttpGet("{pemakaian_internal_id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_pemakaian_internal_no_ed_detail_upload>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_pemakaian_internal_no_ed_detail_upload by id")]
        public async Task<IActionResult> GetDetailUploadByHeaderId(long pemakaian_internal_id)
        {
            ...
            try
            {
                ...
                return Ok(ResponseHelper.GetResponse(
                    _data: new List<tr_pemakaian_internal_no_ed_detail_upload>(),
                    _message: "data tidak ditemukan",
                    _responseResult: true
                ));
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<Int16?>))]
        [SwaggerOperation(summary: "untuk upload data tr_pemakaian_internal_no_ed_detail_upload")]
        public async Task<IActionResult> UploadDetailBerkas([FromForm] tr_pemakaian_internal_no_ed_detail_upload_insert param)
        {
            try
            {
                long result = 0;
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<string>))]
        [SwaggerOperation(summary: "untuk delete data tr_pemakaian_internal_no_ed_detail_upload")]
