...
{
    public class TransAssemblyDao
    {
        public SQLConn db;

        public TransAssemblyDao(SQLConn db)
        {
            this.db = db;
        }
        ...
        public async Task<List<tr_assembly>> GetAllTrAssemblyByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_assembly>("tr_assembly_GetByDynamicFilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<tr_assembly> GetTrAssemblyById(long assembly_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_assembly>("tr_assembly_GetById", new
                {
        ...
        public async Task<tr_assembly> GetTrAssemblyByIdWithLock(long assembly_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_assembly>("tr_assembly_GetById_lock", new
                {
                    _assembly_id = assembly_id
                });
            }
        ...
        public async Task<long> AddTrAssembly(tr_assembly_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_assembly_Insert",
                    new
                    {
        ...
        public async Task<short> UpdateTrAssemblyValidated(tr_assembly_update_to_validated data)
        {
            try
            {
        ...
        public async Task<short> UpdateTrAssemblyCanceled(tr_assembly_update_to_canceled data)
        {
            try
            {
        ...
        public async Task<List<tr_assembly_detail>> GetTrAssemblyDetailByHeaderId(long assembly_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_assembly_detail>("tr_assembly_detail_Getby_headerid", new
                {
                    _assembly_id = assembly_id
                });
            }
        ...
        public async Task<List<tr_assembly_detail>> GetTrAssemblyDetailByHeaderIdWithLock(long assembly_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_assembly_detail>("tr_assembly_detail_Getby_headerid_lock", new
                {
                    _assembly_id = assembly_id
                });
            }
        ...
        public async Task<long> AddTrAssemblyDetail(tr_assembly_detail_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_assembly_detail_Insert",
                    new
                    {
                        _assembly_id = data.assembly_id,
