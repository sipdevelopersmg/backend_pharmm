...
{
    public class TransPenerimaanNoEdDao
    {
        public SQLConn db;

        public TransPenerimaanNoEdDao(SQLConn db)
        {
            this.db = db;
        }
        ...
        public async Task<tr_penerimaan_no_ed_get_sisa_qty_retur> GetSisaQtyRetur(long _penerimaan_detail_item_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_penerimaan_no_ed_get_sisa_qty_retur>("tr_penerimaan_get_sisa_qty_retur_by_penerimaan_detail_id", new
                {
        ...
        public async Task<List<tr_penerimaan_no_ed>> GetAllTrPenerimaanByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_penerimaan_no_ed>("tr_penerimaan_no_ed_getbydynamicfilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<tr_penerimaan_no_ed> GetTrPenerimaanById(long penerimaan_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_penerimaan_no_ed>("tr_penerimaan_GetById", new
                {
        ...
        public async Task<tr_penerimaan_no_ed> GetTrPenerimaanByIdWithLock(long penerimaan_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_penerimaan_no_ed>("tr_penerimaan_getbyid_lock", new
                {
                    _penerimaan_id = penerimaan_id
                });
            }
        ...
        public async Task<long> AddTrPenerimaan(tr_penerimaan_no_ed_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_penerimaan_insert_no_ed",
                    new
                    {
        ...
        public async Task<short> UpdateQtyRetur(tr_penerimaan_no_ed_detail_item_update_qty_retur data)
        {
            try
            {
        ...
        public async Task<short> UpdateToValidated(tr_penerimaan_no_ed_update_status_to_validated data)
        {
            try
            {
        ...
        public async Task<short> UpdateToCanceled(tr_penerimaan_no_ed_update_status_to_canceled data)
        {
            try
            {
        ...
        public async Task<List<tr_penerimaan_no_ed_detail_item>> GetTrPenerimaanDetailItemByHeaderId(long penerimaan_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_penerimaan_no_ed_detail_item>("tr_penerimaan_detail_item_get_by_penerimaan_id", new
                {
                    _penerimaan_id = penerimaan_id
                });
            }
        ...
        public async Task<List<tr_penerimaan_no_ed_detail_item>> GetTrPenerimaanDetailItemByPenerimaanIdWithLock(long penerimaan_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_penerimaan_no_ed_detail_item>("tr_penerimaan_detail_item_get_by_penerimaanid_lock", new
                {
                    _penerimaan_id = penerimaan_id
                });
            }
        ...
        public async Task<long> AddTrPenerimaanDetailItem(tr_penerimaan_no_ed_detail_item_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_penerimaan_detail_item_insert_no_ed",
                    new
                    {
                        _penerimaan_id = data.penerimaan_id,
                        _pemesanan_id = data.pemesanan_id,
        ...
        public async Task<List<tr_penerimaan_no_ed_detail_upload>> GetTrPenerimaanDetailUploadByHeaderId(long penerimaan_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_penerimaan_no_ed_detail_upload>("tr_penerimaan_detail_upload_get_by_penerimaan_id", new
                {
                    _penerimaan_id = penerimaan_id
                });
            }
        ...
        public async Task<List<tr_penerimaan_no_ed_detail_upload>> GetTrPenerimaanDetailUploadById(long penerimaan_detail_upload_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_penerimaan_no_ed_detail_upload>("tr_penerimaan_detail_upload_GetById", new
                {
        ...
        public async Task<long> AddTrPenerimaanDetailUpload(tr_penerimaan_no_ed_detail_upload_insert data)
        {
            try
            {
