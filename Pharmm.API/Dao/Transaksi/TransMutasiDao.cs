...
{
    public class TransMutasiDao
    {
        public SQLConn db;

        public TransMutasiDao(SQLConn db)
        {
            this.db = db;
        }
        ...
        public async Task<List<tr_mutasi>> GetMutasiPermintaanByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_mutasi>("tr_mutasi_permintaan_getbydynamicfilters",
                    new
                    {
                        _filters    // not null
                    });
            ...
            List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_mutasi>("tr_mutasi_permintaan_getby_idstockroom_dynamicfilters",
                    new
                    {
                        _id_stockroom,
                        _filters    // not null
        ...
        public async Task<List<tr_mutasi>> GetAllTrMutasiByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_mutasi>("tr_mutasi_GetByDynamicFilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<tr_mutasi> GetTrMutasiById(long mutasi_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_mutasi>("tr_mutasi_GetById", new
                {
        ...
        public async Task<tr_mutasi> GetTrMutasiByIdWithLock(long mutasi_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_mutasi>("tr_mutasi_GetById_lock", new
                {
                    _mutasi_id = mutasi_id
                });
            }
        ...
        public async Task<long> AddTrMutasi(tr_mutasi_insert data)
        {
            try
            {
        ...
        public async Task<long> AddTrMutasiPermintaan(tr_mutasi_insert_permintaan data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_mutasi_insert_permintaan",
                    new
                    {
                        _id_stockroom_pemberi = data.id_stockroom_pemberi,
                        _id_stockroom_penerima = data.id_stockroom_penerima,
        ...
        public async Task<long> ApproveMutasi(tr_mutasi_approve data)
        {
            try
            {
        ...
        public async Task<short> UpdateTrMutasiCanceled(tr_mutasi_update_to_canceled data)
        {
            try
            {
        ...
        public async Task<long> ApproveMutasiDetailItem(tr_mutasi_detail_item_approve data)
        {
            try
            {
        ...
        public async Task<List<tr_mutasi_detail_item>> GetAllTrMutasiDetailItemByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_mutasi_detail_item>("tr_mutasi_detail_item_GetByDynamicFilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<tr_mutasi_detail_item> GetTrMutasiPermintaanDetailItemById(long _mutasi_detail_item_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_mutasi_detail_item>("tr_mutasi_detail_item_get_by_mutasi_detail_item_id", new
                {
        ...
        public async Task<tr_mutasi_detail_item> GetTrMutasiPermintaanDetailItemByIdWithLock(long _mutasi_detail_item_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_mutasi_detail_item>("tr_mutasi_detail_item_get_by_mutasi_detail_item_id_lock", new
                {
                    _mutasi_detail_item_id
                });
            }
        ...
        public async Task<List<tr_mutasi_detail_item>> GetTrMutasiPermintaanDetailItemByMutasiId(long mutasi_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_mutasi_detail_item>("tr_mutasi_detail_item_get_permintaan_by_mutasi_id", new
                {
                    _mutasi_id = mutasi_id
                });
            }
        ...
        public async Task<List<tr_mutasi_detail_item>> GetTrMutasiDetailItemByMutasiId(long mutasi_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_mutasi_detail_item>("tr_mutasi_detail_item_get_by_mutasi_id", new
                {
                    _mutasi_id = mutasi_id
                });
            }
        ...
        public async Task<long> AddTrMutasiDetailItem(tr_mutasi_detail_item_insert data)
        {
            try
            {
        ...
        public async Task<long> AddTrMutasiDetailItemPermintaan(tr_mutasi_detail_item_insert_permintaan data)
        {
            try
            {
        ...
        public async Task<List<tr_mutasi_detail_item_batch>> GetTrMutasiDetailItemBatchByDetailItemId(long mutasi_detail_item_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_mutasi_detail_item_batch>("tr_mutasi_detail_item_batch_get_by_mutasi_detail_item_id", new
                {
                    _mutasi_detail_item_id = mutasi_detail_item_id
                });
            }
            catch (Exception)
            {
        ...
        public async Task<List<tr_mutasi_detail_item_batch>> GetTrMutasiDetailItemBatchByMutasiId(long mutasi_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_mutasi_detail_item_batch>("tr_mutasi_detail_item_batch_get_by_mutasi_id", new
                {
                    _mutasi_id = mutasi_id
                });
            }
        ...
        public async Task<long> AddTrMutasiDetailItemBatch(tr_mutasi_detail_item_batch_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_mutasi_detail_item_batch_Insert",
                    new
                    {
                        _mutasi_detail_item_id = data.mutasi_detail_item_id,
                        _mutasi_id = data.mutasi_id,
        ...
        public async Task<List<tr_mutasi_detail_upload>> GetTrMutasiDetailUploadByMutasiId(long mutasi_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_mutasi_detail_upload>("tr_mutasi_detail_upload_get_by_mutasi_id", new
                {
                    _mutasi_id = mutasi_id
                });
            }
        ...
        public async Task<tr_mutasi_detail_upload> GetTrMutasiDetailUploadById(long mutasi_detail_upload_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_mutasi_detail_upload>("tr_mutasi_detail_upload_GetById", new
                {
