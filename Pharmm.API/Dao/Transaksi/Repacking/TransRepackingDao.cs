...
{
    public class TransRepackingDao
    {
        public SQLConn db;

        public TransRepackingDao(SQLConn db)
        {
            this.db = db;
        }
        ...
        public async Task<List<tr_repacking>> GetAllTrRepackingByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_repacking>("tr_repacking_GetByDynamicFilters",
                    new
                    {
                        _filters    // not null
                            });
        ...
        public async Task<tr_repacking> GetTrRepackingById(long repacking_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_repacking>("tr_repacking_GetById", new
                {
        ...
        public async Task<tr_repacking> GetTrRepackingByIdWithLock(long repacking_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_repacking>("tr_repacking_GetById_lock", new
                {
                    _repacking_id = repacking_id
                });
            }
        ...
        public async Task<long> AddTrRepacking(tr_repacking_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_repacking_Insert",
                    new
                    {
        ...
        public async Task<short> UpdateTrRepackingValidated(tr_repacking_update_to_validated data)
        {
            try
            {
        ...
        public async Task<short> UpdateTrRepackingCanceled(tr_repacking_update_to_canceled data)
        {
            try
            {
        ...
        public async Task<List<tr_repacking_detail>> GetTrRepackingDetailByHeaderId(long repacking_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_repacking_detail>("tr_repacking_detail_Getby_headerid", new
                {
                    _repacking_id = repacking_id
                });
            }
        ...
        public async Task<List<tr_repacking_detail>> GetTrRepackingDetailByHeaderIdWithLock(long repacking_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_repacking_detail>("tr_repacking_detail_Getby_headerid_lock", new
                {
                    _repacking_id = repacking_id
                });
            }
        ...
        public async Task<long> AddTrRepackingDetail(tr_repacking_detail_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_repacking_detail_Insert",
                    new
                    {
                        _repacking_id = data.repacking_id,
