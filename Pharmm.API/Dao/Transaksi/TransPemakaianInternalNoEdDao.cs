...
{
    public class TransPemakaianInternalNoEdDao
    {
        public SQLConn db;

        public TransPemakaianInternalNoEdDao(SQLConn db)
        {
            this.db = db;
        }
        ...
        public async Task<List<tr_pemakaian_internal_no_ed>> GetAllOpenTrPemakaianInternalByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_pemakaian_internal_no_ed>("tr_pemakaian_internal_no_ed_get_open_dynamicfilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<List<tr_pemakaian_internal_no_ed>> GetAllTrPemakaianInternalByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_pemakaian_internal_no_ed>("tr_pemakaian_internal_no_ed_getbydynamicfilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<tr_pemakaian_internal_no_ed> GetTrPemakaianInternalById(long pemakaian_internal_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_pemakaian_internal_no_ed>("tr_pemakaian_internal_GetById", new
                {
        ...
        public async Task<tr_pemakaian_internal_no_ed> GetTrPemakaianInternalByIdWithLock(long pemakaian_internal_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_pemakaian_internal_no_ed>("tr_pemakaian_internal_GetById_lock", new
                {
                    _pemakaian_internal_id = pemakaian_internal_id
                });
            }
        ...
        public async Task<long> AddTrPemakaianInternal(tr_pemakaian_internal_no_ed_insert data)
        {
            try
            {
                return await this.db.executeScalarSp<long>("tr_pemakaian_internal_no_ed_Insert",
                    new
                    {
        ...
        public async Task<short> UpdateTrPemakaianInternalValidated(tr_pemakaian_internal_no_ed_update_to_validated data)
        {
            try
            {
        ...
        public async Task<short> UpdateTrPemakaianInternalCanceled(tr_pemakaian_internal_no_ed_update_to_canceled data)
        {
            try
            {
        ...
        public async Task<List<tr_pemakaian_internal_no_ed_detail_item>> GetAllTrPemakaianInternalDetailItemByParams(List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return await this.db.QuerySPtoList<tr_pemakaian_internal_no_ed_detail_item>("tr_pemakaian_internal_detail_item_GetByDynamicFilters",
                    new
                    {
                        _filters    // not null
                    });
        ...
        public async Task<List<tr_pemakaian_internal_no_ed_detail_item>> GetTrPemakaianInternalDetailItemByPemakaianInternalId(long pemakaian_internal_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_pemakaian_internal_no_ed_detail_item>("tr_pemakaian_internal_detail_item_get_by_pemakaian_internal_id", new
                {
                    _pemakaian_internal_id = pemakaian_internal_id
                });
            }
        ...
        public async Task<List<tr_pemakaian_internal_no_ed_detail_item>> GetTrPemakaianInternalDetailItemByHeaderIdWithLock(long pemakaian_internal_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_pemakaian_internal_no_ed_detail_item>("tr_pemakaian_internal_detail_item_Getby_headerid_lock", new
                {
                    _pemakaian_internal_id = pemakaian_internal_id
                });
            }
        ...
        public async Task<long> AddTrPemakaianInternalDetailItem(tr_pemakaian_internal_no_ed_detail_item_insert data)
        {
            try
            {
        ...
        public async Task<long> ValidasiDetailItem(tr_pemakaian_internal_no_ed_detail_item_validate data)
        {
            try
            {
        ...
        public async Task<List<tr_pemakaian_internal_no_ed_detail_upload>> GetTrPemakaianInternalDetailUploadByPemakaianInternalId(long pemakaian_internal_id)
        {
            try
            {
                return await this.db.QuerySPtoList<tr_pemakaian_internal_no_ed_detail_upload>("tr_pemakaian_internal_detail_upload_get_by_headerid", new
                {
                    _pemakaian_internal_id = pemakaian_internal_id
                });
            }
        ...
        public async Task<tr_pemakaian_internal_no_ed_detail_upload> GetTrPemakaianInternalDetailUploadById(long pemakaian_internal_detail_upload_id)
        {
            try
            {
                return await this.db.QuerySPtoSingle<tr_pemakaian_internal_no_ed_detail_upload>("tr_pemakaian_internal_detail_upload_GetById", new
                {
