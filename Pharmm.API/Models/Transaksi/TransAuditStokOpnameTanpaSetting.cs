...
namespace Pharmm.API.Models.Transaksi
{
    ...
    public record tr_audit_stok_opname_no_setting_detail_getby_headerid_and_waktu
    {
    ...
    public record tr_audit_stok_opname_no_setting_detail_batch_getby_detailid_and_waktu
    {
    ...
    public record tr_audit_stok_opname_no_setting_header_update_after_proses
    {
    ...
    public record tr_audit_stok_opname_no_setting_header_update_after_adjust
    {
        ...
        public List<tr_audit_stok_opname_no_setting_detail_update_after_adjust> details { get; set; }

    }



    public record tr_audit_stok_opname_no_setting_detail_update_after_adjust
    {
        ...
        public List<tr_audit_stok_opname_no_setting_detail_batch_update_after_adjust> detailBatchs { get; set; }

    }

    public record tr_audit_stok_opname_no_setting_detail_batch_update_after_adjust
    {
    ...
    public record tr_audit_stok_opname_no_setting_lookup_barang_param
    {

        public short id_stockroom { get; set; } //smallint()
        public DateTime waktu_capture { get; set; } //timestamp without time zone()
        public List<ParameterSearchModel> param { get; set; }

    }


    public record tr_audit_stok_opname_no_setting_lookup_barang_batch_param
    {
    ...
    public record tr_audit_stok_opname_no_setting_lookup_barang_header
    {
    ...
    public record tr_audit_stok_opname_no_setting_lookup_barang_batch
    {
    ...
    public record tr_audit_stok_opname_no_setting_header
    {
    ...
    public record tr_audit_stok_opname_no_setting_header_recursive
    {
        ...
        public List<tr_audit_stok_opname_no_setting_detail> details
        {
            get => JsonConvert.DeserializeObject<List<tr_audit_stok_opname_no_setting_detail>>(this._details.Replace("_batchs", "batchs"));
    ...
    public record tr_audit_stok_opname_no_setting_header_insert
    {
        ...
        public string keterangan_entry { get; set; } //character varying()
        internal short? user_inputed { get; set; } //smallint()
        public List<tr_audit_stok_opname_no_setting_detail_insert> details { get; set; }
    ...
    public record tr_audit_stok_opname_no_setting_detail_for_adjustment_finalisasi
    {
        ...
        internal List<tr_audit_stok_opname_no_setting_detail_batch_for_adjustment_finalisasi> _listBatchs { get; set; }

        public List<tr_audit_stok_opname_no_setting_detail_batch_for_adjustment_finalisasi> batchs
        {
            get
            {
                ...
                {
                    return JsonConvert.DeserializeObject<List<tr_audit_stok_opname_no_setting_detail_batch_for_adjustment_finalisasi>>(this._batchs);
                }
                else
                {
                    return _listBatchs;
    ...
    public record tr_audit_stok_opname_no_setting_detail
    {
        ...
        internal string _batchs { get; set; }
        internal List<tr_audit_stok_opname_no_setting_detail_batch> _listBatchs { get; set; }

        public List<tr_audit_stok_opname_no_setting_detail_batch> batchs
        {
            get
            {
                //dari json maupun dari list
                if (this._batchs is not null)
                {
                    return JsonConvert.DeserializeObject<List<tr_audit_stok_opname_no_setting_detail_batch>>(this._batchs);
                }
                else
                {
                    return _listBatchs;
    ...
    public record tr_audit_stok_opname_no_setting_detail_insert
    {
        ...
        public decimal sub_total_fisik { get; set; } //numeric()
        public decimal sub_total_sistem_capture_stok { get; set; } //numeric()
        public List<tr_audit_stok_opname_no_setting_detail_batch_insert> detailBatchs { get; set; }
    }
    ...
    public record tr_audit_stok_opname_no_setting_detail_batch_for_adjustment_finalisasi
    {
    ...
    public record tr_audit_stok_opname_no_setting_detail_batch
    {
    ...
    public record tr_audit_stok_opname_no_setting_detail_batch_insert
    {
