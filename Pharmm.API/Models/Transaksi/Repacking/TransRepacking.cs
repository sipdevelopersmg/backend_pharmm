...
namespace Pharmm.API.Models.Transaksi
{
    ...
    public record tr_repacking_insert
    {
        ...
        public List<tr_repacking_detail_insert> details { get; set; }

    }

    public record tr_repacking_update_to_validated
    {
    ...
    public record tr_repacking_update_to_canceled
    {
    ...
    public record tr_repacking_detail
    {
    ...
    public record tr_repacking_detail_insert
    {
