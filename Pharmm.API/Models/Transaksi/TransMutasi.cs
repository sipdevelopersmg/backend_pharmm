...
namespace Pharmm.API.Models.Transaksi
{
    ...
    public record tr_mutasi_approve
    {
        ...
        public List<tr_mutasi_detail_item_approve> details { get; init; }
    }


    public record tr_mutasi_insert
    {
        ...
        public List<tr_mutasi_detail_item_insert> details { get; init; }

    }


    public record tr_mutasi_insert_permintaan
    {
        ...
        public List<tr_mutasi_detail_item_insert_permintaan> details { get; init; }

    }


    public record tr_mutasi_update_to_validated
    {
    ...
    public record tr_mutasi_update_to_canceled
    {
    ...
    public record tr_mutasi_detail_item_approve
    {
        ...
        public List<tr_mutasi_detail_item_batch_insert> detailBatch { get; set; }

    }


    public record tr_mutasi_detail_item
    {
    ...
    public record tr_mutasi_detail_item_for_default_mutasi
    {
    ...
    public record tr_mutasi_detail_item_insert_permintaan
    {
        ...
        //public List<tr_mutasi_detail_item_batch_insert> detailBatchs { get; init; }
    }


    public record tr_mutasi_detail_item_insert
    {
    ...
    public record tr_mutasi_detail_item_batch
    {

        public long? mutasi_detail_item_batch_id { get; set; } //bigint()
        public long? mutasi_detail_item_id { get; set; } //bigint()
        public long? mutasi_id { get; set; } //bigint()
    ...
    public record tr_mutasi_detail_item_batch_insert
    {

        internal long? mutasi_detail_item_id { get; set; } //bigint()
        internal long? mutasi_id { get; set; } //bigint()
        public string batch_number { get; set; } //character varying()
    ...
    public record tr_mutasi_detail_upload
    {
    ...
    public record tr_mutasi_detail_upload_insert
    {
