...
namespace Pharmm.API.Models.Laporan
{
    ...
    public record param_laporan_assembly_per_faktur
    {
    ...
    public record laporan_assembly_per_faktur
    {
        ...
        public decimal? hpp_satuan_jadi { get; set; } //numeric()
        ...
        public decimal? hpp_satuan_dari { get; set; } //numeric()
