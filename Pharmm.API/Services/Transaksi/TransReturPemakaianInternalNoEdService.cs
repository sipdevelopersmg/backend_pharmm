...
{
    public interface ITransReturPemakaianInternalNoEdService
    {
        #region Header

        Task<List<tr_retur_pemakaian_internal_no_ed>> GetAllTrReturPemakaianInternalByParams(List<ParameterSearchModel> param);
        Task<tr_retur_pemakaian_internal_no_ed> GetTrReturPemakaianInternalById(long retur_pemakaian_internal_id);

        Task<long> AddTrReturPemakaianInternal(tr_retur_pemakaian_internal_no_ed_insert data);

        Task<(bool, long, string)> UpdateToValidated(tr_retur_pemakaian_internal_no_ed_update_to_validated data);
        Task<(bool, long, string)> UpdateToCanceled(tr_retur_pemakaian_internal_no_ed_update_to_canceled data);

        #endregion

        #region Detail Item

        Task<List<tr_retur_pemakaian_internal_no_ed_detail_item>> GetAllTrReturPemakaianInternalDetailItemByParams(List<ParameterSearchModel> param);
        Task<List<tr_retur_pemakaian_internal_no_ed_detail_item>> GetTrReturPemakaianInternalDetailItemByHeaderId(long retur_pemakaian_internal_item_id);

        #endregion

        #region Detail Upload

        Task<List<tr_retur_pemakaian_internal_no_ed_detail_upload>> GetTrReturPemakaianInternalDetailUploadByHeaderId(long retur_pemakaian_internal_id);
        Task<long> AddTrReturPemakaianInternalDetailUpload(tr_retur_pemakaian_internal_no_ed_detail_upload_insert data);
    ...
    public class TransReturPemakaianInternalNoEdService : ITransReturPemakaianInternalNoEdService
    {
        private readonly SQLConn _db;
        private readonly TransReturPemakaianInternalNoEdDao _dao;
        private readonly TransPemakaianInternalNoEdDao _internalDao;
        ...
        public TransReturPemakaianInternalNoEdService(SQLConn db, TransReturPemakaianInternalNoEdDao dao,
            MasterCounterDao kodeDao,
            SetupStokItemDao stokItemDao,
            KartuStokItemDao kartuStokDao,
            TransPemakaianInternalNoEdDao internalDao)
        {
            this._db = db;
            this._dao = dao;
        ...
        public async Task<(bool, long, string)> UpdateToValidated(tr_retur_pemakaian_internal_no_ed_update_to_validated data)
        {
            this._db.beginTransaction();
                            ...
                            if (rekapForHeader.Count > 0)
                            {
                                foreach (var item in rekapForHeader)
                                {
                                    ...
                                    var kartuStokParam = new mm_kartu_stok_item_insert_penambahan_stok
                                    {
                                        ...
                                        keterangan = "MASUK RETUR PEMAKAIAN INTERNAL TANPA ED",
        ...
        public async Task<(bool, long, string)> UpdateToCanceled(tr_retur_pemakaian_internal_no_ed_update_to_canceled data)
        {
        ...
        public async Task<List<tr_retur_pemakaian_internal_no_ed_detail_item>> GetTrReturPemakaianInternalDetailItemByHeaderId(long retur_pemakaian_internal_item_id)
        {
            try
            {
        ...
        public async Task<List<tr_retur_pemakaian_internal_no_ed_detail_upload>> GetTrReturPemakaianInternalDetailUploadByHeaderId(long retur_pemakaian_internal_id)
        {
            try
            {
