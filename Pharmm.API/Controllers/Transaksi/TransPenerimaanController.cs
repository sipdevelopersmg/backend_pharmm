...
namespace Pharmm.API.Controllers.Transaksi
{
    ...
    [ApiController]
    public class TransPenerimaanController : ControllerBase
    {
        private ITransPenerimaanService _service;
        ...
        private readonly ILogger<TransPenerimaanController> _logger;

        public TransPenerimaanController(ITransPenerimaanService service,
            ISetupUkuranDokumenService dokumenService,
        ILogger<TransPenerimaanController> logger,
        ...
        [SwaggerOperation(summary: "untuk mendapatkan data tr_penerimaan_detail_item by penerimaan_id")]
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_penerimaan>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_penerimaan by dynamic filter (gunakan array kosong [] untuk get all data)",
            description: "prefix tr_penerimaan = tp, <br> " +
        ...
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_penerimaan>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_penerimaan")]
        public async Task<IActionResult> GetAll()
        {

            try
            {
                var result = await this._service.GetAllTrPenerimaan();
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<tr_penerimaan>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_penerimaan by id")]
        ...
        [SwaggerOperation(summary: "untuk mendapatkan nomor penerimaan")]
        public async Task<IActionResult> GetNoPenerimaan()
        {
        ...
        [SwaggerOperation(summary: "untuk input data tr_penerimaan")]
        public async Task<IActionResult> Insert([FromBody] tr_penerimaan_insert param)
        {
            try
            {
        ...
        public async Task<IActionResult> UpdateToValidated([FromBody] tr_penerimaan_update_status_to_validated param)
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<string>))]
        [SwaggerOperation(summary: "untuk update data tr_penerimaan")]
        public async Task<IActionResult> UpdateToCanceled([FromBody] tr_penerimaan_update_status_to_canceled param)
        {
            try
            {
                var result = 0;
        ...
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_penerimaan_detail_item>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_penerimaan_detail_item")]
        public async Task<IActionResult> GetAllDetailItem()
        {

            try
            {
                var result = await this._service.GetAllTrPenerimaanDetailItem();
                ...
                return Ok(ResponseHelper.GetResponse(
                    _data: new List<tr_penerimaan_detail_item>(),
                    _message: "data tidak ditemukan",
                    _responseResult: true
                ));
        ...
        public async Task<IActionResult> GetDetailItemByPenerimaanId(long penerimaan_id)
        {
            ...
            try
            {
                var result = await this._service.GetTrPenerimaanDetailItemByPenerimaanId(penerimaan_id);
        ...
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_penerimaan_detail_upload>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_penerimaan_detail_upload")]
        public async Task<IActionResult> GetAllDetailUpload()
        {

            try
            {
                var result = await this._service.GetAllTrPenerimaanDetailUpload();
                ...
                return Ok(ResponseHelper.GetResponse(
                    _data: new List<tr_penerimaan_detail_upload>(),
                    _message: "data tidak ditemukan",
                    _responseResult: true
                ));
        ...
        [HttpGet("{penerimaan_id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_penerimaan_detail_upload>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_penerimaan_detail_upload by penerimaan_id")]
        public async Task<IActionResult> GetDetailUploadByPenerimaanId(long penerimaan_id)
        {

            try
            {
                var result = await this._service.GetTrPenerimaanDetailUploadByPenerimaanId(penerimaan_id);
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<Int16?>))]
        [SwaggerOperation(summary: "untuk upload data tr_penerimaan_detail_upload")]
        public async Task<IActionResult> UploadDetailBerkas([FromForm] tr_penerimaan_detail_upload_insert param)
        {
            try
            {
                long result = 0;
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<string>))]
        [SwaggerOperation(summary: "untuk delete data tr_penerimaan_detail_upload")]
