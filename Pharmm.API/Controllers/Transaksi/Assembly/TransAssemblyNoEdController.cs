...
namespace Pharmm.API.Controllers.Transaksi
{
    ...
    [ApiController]
    public class TransAssemblyNoEdController : ControllerBase
    {
        private ISetupStokItemService _stokItemService;
        private ITransAssemblyNoEdService _service;
        private readonly ILogger<TransAssemblyNoEdController> _logger;

        public TransAssemblyNoEdController(
            ITransAssemblyNoEdService service,
            ISetupStokItemService stokItemService,
            ILogger<TransAssemblyNoEdController> logger)
        {
            this._logger = logger;
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<List<tr_assembly_no_ed>>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_assembly_no_ed by dynamic filter (gunakan array kosong [] untuk get all data)", description: "prefix tr_assembly_no_ed = tr")]
        public async Task<IActionResult> GetAllByParams([FromBody] List<ParameterSearchModel> param)
        {
            ...
            try
            {
                ...
                return Ok(ResponseHelper.GetResponse(
                    _data: new List<tr_assembly_no_ed>(),
                    _message: "data tidak ditemukan",
                    _responseResult: true
                ));
        ...
        [HttpGet("{assembly_id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<tr_assembly_no_ed>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_assembly_no_ed by id")]
        ...
        [SwaggerOperation(summary: "untuk input data tr_assembly_no_ed")]
        public async Task<IActionResult> Insert([FromBody] tr_assembly_no_ed_insert param)
        {
            try
            {
                ...
                _logger.LogInformation("save data assembly tanpa ed {0}", param);
        ...
        [SwaggerOperation(summary: "untuk validasi data tr_assembly_no_ed")]
        public async Task<IActionResult> Validasi([FromBody] tr_assembly_no_ed_update_to_validated param)
        {
            try
            {
                ...
                _logger.LogInformation("validasi assembly tanpa ed {0}", param);
        ...
        [ApiExplorerSettings(IgnoreApi = false)]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<string>))]
        [SwaggerOperation(summary: "untuk batalkan data tr_assembly_no_ed")]
        public async Task<IActionResult> Batal([FromBody] tr_assembly_no_ed_update_to_canceled param)
        {
            try
            {
                ...
                _logger.LogInformation("batalkan assembly tanpa ed {0}", param);
        ...
        [HttpGet("{assembly_id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ResponseModel<tr_assembly_no_ed_detail>))]
        [SwaggerOperation(summary: "untuk mendapatkan data tr_assembly_no_ed_detail by id")]
