...
namespace Pharmm.API.Models.Transaksi
{
    ...
    public record tr_pemakaian_internal_no_ed
    {
    ...
    public record tr_pemakaian_internal_no_ed_insert
    {
        ...
        public List<tr_pemakaian_internal_no_ed_detail_item_insert> details { get; init; }

    }


    public record tr_pemakaian_internal_no_ed_update_to_validated
    {
        public long pemakaian_internal_id { get; set; } //bigint()
        public string pic_pemberi { get; set; } //character varying()
        public string pic_penerima { get; set; } //character varying()
        ...
        public List<tr_pemakaian_internal_no_ed_detail_item_validate> details { get; set; }

    }


    public record tr_pemakaian_internal_no_ed_update_to_canceled
    {
    ...
    public record tr_pemakaian_internal_no_ed_detail_item_validate
    {
    ...
    public record tr_pemakaian_internal_no_ed_detail_item
    {
    ...
    public record tr_pemakaian_internal_no_ed_detail_item_insert
    {
    ...
    public record tr_pemakaian_internal_no_ed_detail_upload
    {
    ...
    public record tr_pemakaian_internal_no_ed_detail_upload_insert
    {
