...
namespace Pharmm.API.Models.Transaksi
{
    ...
    public record tr_retur_pembelian_update_status_to_validated
    {
    ...
    public record tr_retur_pembelian_update_status_to_canceled
    {
        public long retur_pembelian_id { get; set; }
    ...
    public record tr_retur_pembelian_cek_status
    {
    ...
    public record tr_retur_pembelian
    {
    ...
    public record tr_retur_pembelian_insert
    {
        ...
        public List<tr_retur_pembelian_detail_insert> details { get; init; }
    }
    ...
    public record tr_retur_pembelian_detail
    {
    ...
    public record tr_retur_pembelian_detail_insert
    {
    ...
    public record tr_retur_pembelian_detail_penukaran
    {
        ...
        public string batch_number { get; set; } //String(-1)
        public DateTime? expired_date { get; set; } //DateTime(-1)
