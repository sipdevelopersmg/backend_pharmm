...
namespace Pharmm.API.Models.Transaksi
{
    ...
    public record tr_repacking_no_ed
    {

        public long repacking_id { get; set; } //bigint()
        public string nomor_repacking { get; set; } //character varying(20)
        ...
        public string keterangan_repacking { get; set; } //character varying(150)
    ...
    public record tr_repacking_no_ed_insert
    {

        public string nomor_repacking { get; set; } //character varying()
        public DateTime? tanggal_repacking { get; set; } //timestamp without time zone()
        public short? id_stockroom { get; set; } //smallint()
        public int? id_item { get; set; } //integer()
        public decimal? qty { get; set; } //numeric()
        ...
        public List<tr_repacking_no_ed_detail_insert> details { get; set; }

    }

    public record tr_repacking_no_ed_update_to_validated
    {
    ...
    public record tr_repacking_no_ed_update_to_canceled
    {
    ...
    public record tr_repacking_no_ed_detail
    {

        public long repacking_detail_id { get; set; } //bigint()
        public long repacking_id { get; set; } //bigint()
    ...
    public record tr_repacking_no_ed_detail_insert
    {

        internal long? repacking_id { get; set; } //bigint()
        public short? no_urut { get; set; } //smallint()
        public int? id_item_child { get; set; } //integer()
        public decimal? qty { get; set; } //numeric()
        public decimal? hpp_satuan { get; set; } //numeric()
