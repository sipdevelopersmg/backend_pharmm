...
namespace Pharmm.API.Models.Transaksi
{
    ...
    public record tr_assembly_insert
    {
        ...
        public List<tr_assembly_detail_insert> details { get; set; }

    }

    public record tr_assembly_update_to_validated
    {
    ...
    public record tr_assembly_update_to_canceled
    {
    ...
    public record tr_assembly_detail
    {
    ...
    public record tr_assembly_detail_insert
    {
