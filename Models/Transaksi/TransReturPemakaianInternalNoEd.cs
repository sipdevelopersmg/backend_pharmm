...
{
    #region Header
    public record tr_retur_pemakaian_internal_no_ed
    {
    ...
    public record tr_retur_pemakaian_internal_no_ed_insert
    {
        ...
        public List<tr_retur_pemakaian_internal_no_ed_detail_item_insert> details { get; init; }

    }

    public record tr_retur_pemakaian_internal_no_ed_update_to_validated
    {
    ...
    public record tr_retur_pemakaian_internal_no_ed_update_to_canceled
    {
    ...
    public record tr_retur_pemakaian_internal_no_ed_detail_item
    {
    ...
    public record tr_retur_pemakaian_internal_no_ed_detail_item_insert
    {
    ...
    public record tr_retur_pemakaian_internal_no_ed_detail_upload
    {
    ...
    public record tr_retur_pemakaian_internal_no_ed_detail_upload_insert
    {
