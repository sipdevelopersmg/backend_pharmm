...
namespace Pharmm.API.Models.Transaksi
{
    ...
    public record tr_penerimaan_detail_item_update_qty_retur
    {
    ...
    public record tr_penerimaan_update_status_to_validated
    {
    ...
    public record tr_penerimaan_update_status_to_canceled
    {
        public long penerimaan_id { get; set; }
    ...
    public record tr_penerimaan
    {
        ...
        //public List<tr_penerimaan_detail_item> details
        //{
        //    get
        //    {
        //        return JsonConvert.DeserializeObject<List<tr_penerimaan_detail_item>>(this._details);
        //    }
    ...
    public record tr_penerimaan_insert
    {
        ...
        public List<tr_penerimaan_detail_item_insert> details { get; init; }
    }
    ...
    public record tr_penerimaan_detail_item
    {
        public long? penerimaan_detail_item_id { get; set; } //bigint()
        public long? penerimaan_id { get; set; } //bigint()
        public long? pemesanan_id { get; set; } //bigint()
    ...
    public record tr_penerimaan_detail_item_insert
    {
    ...
    public record tr_penerimaan_get_sisa_qty_retur
    {
    ...
    public record tr_penerimaan_detail_upload
    {
    ...
    public record tr_penerimaan_detail_upload_insert
    {
        public long penerimaan_id { get; set; }
