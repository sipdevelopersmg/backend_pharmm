...
namespace Pharmm.API.Models.Transaksi
{
    ...
    public record tr_audit_stok_opname_no_ed_setting_detail_getby_headerid_and_waktu
    {
    ...
    public record tr_audit_stok_opname_no_ed_setting_header_update_after_proses
    {
    ...
    public record tr_audit_stok_opname_no_ed_setting_header_update_after_adjust
    {
        ...
        public List<tr_audit_stok_opname_no_ed_setting_detail_update_after_adjust> details { get; set; }

    }



    public record tr_audit_stok_opname_no_ed_setting_detail_update_after_adjust
    {
    ...
    public record tr_audit_stok_opname_no_ed_setting_lookup_barang_param
    {
    ...
    public record tr_audit_stok_opname_no_ed_setting_lookup_barang_header
    {
    ...
    public record tr_audit_stok_opname_no_ed_setting_header
    {
    ...
    public record tr_audit_stok_opname_no_ed_setting_header_recursive
    {
        ...
        public List<tr_audit_stok_opname_no_ed_setting_detail> details
        {
            get => JsonConvert.DeserializeObject<List<tr_audit_stok_opname_no_ed_setting_detail>>(this._details);
    ...
    public record tr_audit_stok_opname_no_ed_setting_header_insert
    {
        ...
        public string keterangan_entry { get; set; } //character varying()
        internal short? user_inputed { get; set; } //smallint()
        public List<tr_audit_stok_opname_no_ed_setting_detail_insert> details { get; set; }
    ...
    public record tr_audit_stok_opname_no_ed_setting_detail_for_adjustment_finalisasi
    {
    ...
    public record tr_audit_stok_opname_no_ed_setting_detail
    {
    ...
    public record tr_audit_stok_opname_no_ed_setting_detail_insert
    {
